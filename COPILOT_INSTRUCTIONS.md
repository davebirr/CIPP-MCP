...
- **Azure Function App:** Deploy using Azure best practices (slot-based deployment, managed identity, etc.).
- **Secrets Management:** Store secrets in Azure Key Vault, never in code or config files.
